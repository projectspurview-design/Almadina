...
public class LocationDetailsActivity extends AppCompatActivity {
    ...
    private String loginId; // ⬅️ add this
...
//        backButton.setOnClickListener(v -> finish());
        nextButton.setOnClickListener(v -> {
            if (selectedRowIndex >= 0 && selectedRowIndex < allLocations.size()) {
                ...
                if (selectOnly) {
                    ...
                    intent.putExtra("PICK_USER", pickUser);
                    intent.putExtra("TOTAL_ITEMS", allLocations.size());
                    intent.putExtra("COMPLETED_ITEMS", 0);
    ...
    private void goBackToTransactionList() {
        ...
        // Avoid stacking multiple list screens
    ...
    private void navigateUp() {
        ...
        // land on the page where the new selection sits
    ...
    private void updateArrowStates() {
        ...
        arrowUp.setEnabled(hasData);
        arrowDown.setEnabled(hasData);
        arrowUp.setAlpha(hasData ? 1f : 0.4f);
        arrowDown.setAlpha(hasData ? 1f : 0.4f);
    }
