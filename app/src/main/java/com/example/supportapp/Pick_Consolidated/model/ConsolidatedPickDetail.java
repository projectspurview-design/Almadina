...
public class ConsolidatedPickDetail implements Parcelable {
    ...
    // ===== Parcelable (write coerced strings) =====
    ...
    public static final Creator<ConsolidatedPickDetail> CREATOR = new Creator<>() {
        @Override public ConsolidatedPickDetail createFromParcel(Parcel in) { return new ConsolidatedPickDetail(in); }
        @Override public ConsolidatedPickDetail[] newArray(int size) { return new ConsolidatedPickDetail[size]; }
    };
}
