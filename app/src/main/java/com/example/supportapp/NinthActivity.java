...
public class NinthActivity extends AppCompatActivity {
    ...
    private void fetchOrderSummary(String as_prin_code, String as_job_no, String as_order_no, String as_login_id) {
        try {
                    ...
                    if (response.isSuccessful()) {
                        try {
                            ...
                            if (responseBody.isEmpty()) {
                                runOnUiThread(() -> Toast.makeText(NinthActivity.this, "Empty response from API", Toast.LENGTH_SHORT).show());
                                return;
                            }
                            ...
                            if (orderSummary.length() > 0) {
                                ...
                                runOnUiThread(() -> Toast.makeText(NinthActivity.this, "No data available", Toast.LENGTH_SHORT).show());
                            }
            ...
            runOnUiThread(() -> Toast.makeText(NinthActivity.this, "Error creating request: " + e.getMessage(), Toast.LENGTH_SHORT).show());
        }
    }
    ...
    private void sendResumeJobPickingApiCall() {
        ...
        try {
            ...
            runOnUiThread(() -> Toast.makeText(NinthActivity.this, "Error preparing resume picking request: " + e.getMessage(), Toast.LENGTH_SHORT).show());
        }
    }
