...
public final class ApiConfig {
    ...
    public static final String CONSOLIDATED_PREFIX = "api/ConsolidatedPicking/";

    public static final String START_CONSOLIDATED_PICKING =
            BASE_URL + CONSOLIDATED_PREFIX + "START_CONSOLIDATED_PICKING";

    public static final String PAUSE_CONSOLIDATED_PICKING =
            BASE_URL + CONSOLIDATED_PREFIX + "PAUSE_CONSOLIDATED_PICKING";

    public static final String RESUME_CONSOLIDATED_PICKING =
            BASE_URL + CONSOLIDATED_PREFIX + "RESUME_CONSOLIDATED_PICKING";

    public static final String GET_CONSOLIDATED_STATUS =
            BASE_URL + CONSOLIDATED_PREFIX + "GET_CONSOLIDATED_STATUS";
