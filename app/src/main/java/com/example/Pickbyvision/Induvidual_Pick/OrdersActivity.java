...
public class OrdersActivity extends AppCompatActivity {
    ...
    private void loadPicklistJobData(String loginId) {
        ...
        executorService.execute(() -> {
            ...
            try {
                ...
                connection.setRequestProperty(ApiConfig.HEADER_ACCEPT, ApiConfig.ACCEPT_ALL);
                connection.setRequestProperty(ApiConfig.HEADER_API_KEY, ApiConfig.API_KEY);
                connection.setRequestProperty(ApiConfig.HEADER_USER_AGENT, ApiConfig.USER_AGENT_VALUE);
                ...
                if (responseCode == HttpURLConnection.HTTP_OK) {
                    ...
                    parsePicklistResponse(response);
    ...
    private void setupSSLBypass(HttpsURLConnection conn) {
        try {
