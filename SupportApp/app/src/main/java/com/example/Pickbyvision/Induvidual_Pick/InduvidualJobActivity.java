...
public class InduvidualJobActivity extends AppCompatActivity {
    ...
    private String getJobNoFromSession() {
        ...
        if (jobNo == null || jobNo.trim().isEmpty()) Log.e(TAG, "Job number missing in OrderSummaryActivity instance.");
        return jobNo;
    }

    private String getOrderNoFromSession() {
        String orderNo = this.orderNumber;
        if (orderNo == null || orderNo.trim().isEmpty()) Log.e(TAG, "Order number missing in OrderSummaryActivity instance.");
        return orderNo;
    }
    ...
    private String getLoginIdFromSession() {
        ...
        if (loginId == null || loginId.trim().isEmpty()) Log.e(TAG, "Login ID missing in OrderSummaryActivity instance.");
        return loginId;
    }
