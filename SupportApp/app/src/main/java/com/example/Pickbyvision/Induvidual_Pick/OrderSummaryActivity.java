...
public class OrderSummaryActivity extends AppCompatActivity {
    ...
    private int initialTotalPicks = 0;   // maps to API total_sku (picks)
    private int initialTotalQty = 0;     // maps to API total_qty
    ...
    private void loadParams() {
        ...
        // From Prefs fallback (saved in OrdersActivity)
    ...
    private void updateTotalsUI() {
        // Keep Order text safe even if API hasn't returned yet
