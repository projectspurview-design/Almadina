...
public class EighthActivity extends AppCompatActivity {
    ...
    // Add a TextView to hold the progress text
    private TextView progressText; // <--- ADD THIS LINE
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        progressText = findViewById(R.id.progressText); // <--- ADD THIS LINE
        ...
        logoutButton.setOnClickListener(v -> {
            ...
            LogoutManager.performLogout(EighthActivity.this);
        });
        ...
        progressText.setText("0/0"); // <--- INITIALIZE PROGRESS TEXT HERE
        ...
        findViewById(R.id.backButton).setOnClickListener(v -> {
            ...
            // Explicitly navigate back to SeventhActivity
            Intent intent = new Intent(EighthActivity.this, SeventhActivity.class);
    ...
    private void setupVoiceCommands() {
        try {
            ...
            Log.e(TAG, "Voice command registration failed: " + e.getMessage());
        }
    }
    ...
    private void showUserDataError() {
        ...
        pausedStatusText.setVisibility(TextView.GONE);
        progressText.setText("0/0"); // <--- UPDATE PROGRESS TEXT ON ERROR
    ...
    private void handleNextButtonClick() {
        ...
        // In EighthActivity - Check this part:
        Intent intent = new Intent(EighthActivity.this, OrderSummaryActivity.class);
        intent.putExtra("ORDER_NUMBER", orderNumber);  // This should be "TEST JOB_1/21082025"
        intent.putExtra("JOB_NUMBER", jobNumber);      // This should be "1025088269"
        intent.putExtra("USER_ID", currentUserId);     // This should be "RAHUL"
        intent.putExtra("PRIN_CODE", prinCode);        // This should be "029" ← KEY FIX
    ...
    private void loadPicklistJobData(String loginId) {
        ...
        executorService.execute(() -> {
            ...
            try {
                ...
                // CRITICAL: Add SSL bypass for HTTPS connections
    ...
    private void setupSSLBypass(HttpsURLConnection connection) {
        try {
            ...
            // Apply the SSL bypass to the connection
    ...
    private void parsePicklistResponse(String jsonResponse) {
        try {
            ...
            // ✅ Store full job list and reset index
            ...
            // ✅ Update UI using job at index 0
            mainHandler.post(() -> {
            ...
            try {
                ...
                this.jobList = new JSONArray(); // wrap in array for consistency
                this.jobList.put(singleJob);
                this.currentJobIndex = 0;

                mainHandler.post(() -> updateUIWithBackendData(singleJob, 1)); // <--- Pass total jobs as 1 for single job
    ...
    private void updateUIWithBackendData(JSONObject jobData, int totalJobs) {
        try {
            ...
            // Update the progress text here
            if (progressText != null) {
                progressText.setText((currentJobIndex + 1) + "/" + totalJobs); // <--- ADD THIS LINE
            }
            ...
            if (!jobNumber.isEmpty()) {
                ...
                editor.putString("CURRENT_JOB_NO", jobNumber); // ✅ FIX: Save under expected key
...
// Update order number - from server data
            if (!orderNumber.isEmpty()) {
                orderNumberText.setText("Order number: " + orderNumber);
                editor.putString("ORDER_NUMBER", orderNumber);
                editor.putString("CURRENT_ORDER_NO", orderNumber); // ✅ FIX: Save under expected key
                Log.d(TAG, "Order Number for user " + currentUserId + ": " + orderNumber);
            } else {
                orderNumberText.setText("Order number: Not available");
                Log.w(TAG, "No order number for user " + currentUserId);
    ...
    private void showNoDataMessage() {
        ...
        pausedStatusText.setVisibility(TextView.GONE);
        progressText.setText("0/0"); // <--- UPDATE PROGRESS TEXT WHEN NO DATA
    ...
    private void showFallbackData() {
        ...
        pausedStatusText.setVisibility(TextView.GONE);
        progressText.setText("0/0"); // <--- UPDATE PROGRESS TEXT ON FALLBACK
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == 1 && resultCode == RESULT_OK) {
            ...
            // If the activity returns and jobs are loaded, ensure progress is updated
